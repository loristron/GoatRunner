...
public class Fase1 extends BasicGameState {
    ...
    private float pontos = 1;
    //moedas fase 1
    public int moedasFase1 = 0;

    //---------------------------- SERÃO 5 OBSTÁCULOS NA PRIMEIRA FASE: ----
    public float yObstaculos = 410; // o Y não varia
    ...
    //-----------------------------------------------------------------------
    //---------------------------- SERAO 3 ESTRELAS NA PRIMEIRA FASE: -------
    public float yEstrelas = 330;
    public float xEstrela1 = 780 + 400;
    public float xEstrela2 = 780 + 200 + 450;
    public float xEstrela3 = 780 + 200 + 450 + 280 + 280;
    ...
    public boolean pegouEstrela = false;

    public static final float VOLUME_MUSICA_FUNDO = 0.5f;
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
        ...
        String estrelass = Integer.toString(moedasFase1 + Integer.parseInt(Usuarios.getUsuarioAtual().getEstrelas()));
        ...
        if (goatIsAlive) {
            ...
            if (xObstaculo5 < 25) {
                g.drawString("Você passou a fase 1! Pressione Enter para ir para a tela de níveis!", GoatRunner.LARGURA_JANELA / 9, GoatRunner.ALTURA_JANELA / 3);
                System.out.println("Voce ganhou");
                if (input.isKeyPressed(KEY_ENTER)) {
                    try {
                        persiste.atualizaMoedas(moedasFase1);
            ...
            g.drawString("Você perdeu! Pressione Enter para jogar novamente ou ESC pra ir para as fases.", GoatRunner.LARGURA_JANELA / 5, GoatRunner.ALTURA_JANELA / 3);
            if (input.isKeyPressed(KEY_ENTER)) {
                try {
                    restartState();
                } catch (SQLException ex) {
    ...
    public void restartState() throws SQLException {
        goatX = 50;
        goatY = 370;
        xObstaculo1 = 780;
        xObstaculo2 = 780 + 400;
        xObstaculo3 = 780 + 200 + 450;
        xObstaculo4 = 780 + 200 + 450 + 300;
        xObstaculo5 = 780 + 200 + 450 + 280 + 280;

        xEstrela1 = 780;
        xEstrela2 = 780 + 400;
        xEstrela3 = 780 + 450 + 200;
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
        ...
        if (goatIsAlive) {
            //Trazendo os obstáculos para a tela
            ...
            // Se o personagem ainda NÃO passou do último obstáculo
            if (xObstaculo5 >= 25) {
